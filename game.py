...
from hackaton_gamejam.special_effects import Phase_In
...
pyglet.resource.path = ['tiles', '', 'Map_Modules', '/tiles/fence', '/assets/entity/player/walking', '/assets/entity/player/standing', '/assets/entity/player/jumping']
